...
modelroot = os.environ['HOME']+'/e3sm_v3' 
...
if (runtype == 'site'):
    sites = ['US-Ha1']               #Site name, list of site names, or 'all' for all sites in site group
...
parm_list      = 'parm_list_us_ha1'  #Set parameter list (leave blank for no ensemble)
...
postproc_vars  = ['GPP','ER']  #Variables to automatically post-process
